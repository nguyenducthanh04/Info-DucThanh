...
import "./App.css";
import avatar from "../src/assets/images/thanhdz.jpg";
    ...
    return (
        <div>
            {isMobile ? (
                                ...
                                <div className="general-mobile">
                                    ...
                                    <div className="about-content-mobile">
                                        <p className="p-1-mobile">
                                            Mình là một sinh viên của trường đại
                                            học Đại Nam. Mình đang học tập
                                            chuyên ngành Công Nghệ Thông Tin.
                                        </p>
                                        <p className="p-2-mobile">
                                            Nhưng ước mơ của mình vẫn là được
                                            đứng trong hàng ngũ của lực lượng
                                            CAND, mình luôn phấn đấu hết mình để
                                            không phải hối tiếc điều gì ở tuổi
                                            trẻ.
                                        </p>
                                    </div>
                                </div>
                                                ...
                                                <li>
                                                    <div>
                                                        ...
                                                        <p>
                                                            ...
                                                            nhất ở trường, khi
                                                            đó tìm tòi kênh
                                                            youtube dạy HTML CSS
                                                            may mắn biết đến anh
                                                            Sơn F8, sau đó anh
                                                            Sơn có mở lớp
                                                            BackEnd Offline,
                                                            liền đăng ký và trở
                                                ...
                                                <div className="name-film-mobile">
                                                    ...
                                                    <div className="content-film-mobile">
                                                        <span>
                                                            ...
                                                            phim hoạt hình Nhật
                                                            Bản của hãng phim
                                                            hoạt hình Ghibli sản
                                                            xuất năm 1988 do đạo
                                                            diễn Takahata Isao
                                                            viết kịch bản và đạo
                                                            diễn. Bộ phim được
                                                            dựa theo cuốn tiểu
                                                            thuyết cùng tên của
                                                            Nosaka Akiyuki vốn
                                                ...
                                                <div className="name-film-mobile">
                                                    ...
                                                    <div className="content-film-mobile">
                                                        <span>
                                                            ...
                                                            Bones. Mùa đầu tiên
                                                            lên sóng tại Nhật
                                                            Bản từ 3 tháng 4 đến
                                                            26 tháng 6 năm 2016,
                                                            theo sau bởi mùa thứ
                                                            hai từ 1 tháng 4 đến
                                                            30 tháng 9 năm 2017.
                                                            Mùa thứ ba bắt đầu
                                                            lên sóng từ 7 tháng
                                                            4 năm 2018, đồng
                ...
                <div className="App">
                    <div
                        className={`${isDarkMode ? "dark-mode-info" : "info"}`}
                    >
                                ...
                                <div className="about-self">
                                    <div className="general">
                                        ...
                                        <div className="about-content">
                                            <p className="p-1">
                                                Mình là một sinh viên của trường
                                                đại học Đại Nam. Mình đang học
                                                tập chuyên ngành Công Nghệ Thông
                                                Tin.
                                            </p>
                                            <p className="p-2">
                                                Nhưng ước mơ của mình vẫn là
                                                được đứng trong hàng ngũ của lực
                                                lượng CAND, mình luôn phấn đấu
                                                hết mình để không phải hối tiếc
                                                điều gì ở tuổi trẻ.
                                            </p>
                                        </div>
                                    </div>
